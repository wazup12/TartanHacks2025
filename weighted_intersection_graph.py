...
if __name__ == "__main__":
    ...
    image_filenames = []  # Store generated image filenames
    ...
    result = {
        ...
        'longitude': lon,
        'message': f'Coordinates found for {place_name}',
        'map_images': [f"/static/{img}" for img in image_filenames]  # Return multiple image URLs
    }
